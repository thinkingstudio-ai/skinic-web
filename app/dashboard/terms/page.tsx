    ...
    <div className="space-y-8 max-w-2xl">
      ...
      <div className="card-glass rounded-2xl p-5 border border-white/10">
        ...
        <div className="flex flex-wrap gap-3">
          <a href="/how-it-works" target="_blank" rel="noreferrer" className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-white/60 text-sm font-medium hover:bg-white/10 transition-colors">
            How It Works →
          </a>
