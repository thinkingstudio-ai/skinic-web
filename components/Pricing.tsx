...
const STUDIO_TIERS: Tier[] = [
  {
    ...
    limits: [
      { label: "Monthly scans / API calls", value: "20", tooltip: "20 free AI skin profiles per month to evaluate the experience. Also counts toward API usage." },
      { label: "Catalog items", value: "2 items", tooltip: "Add up to 2 products or services to sample the matching engine. Unlimited on Starter and above." },
      { label: "Lead capture", value: "Collected", tooltip: "Your scan page collects name + email on every scan. Viewing the Customer DB and CSV export unlock on Starter." },
    ],
    features: [
      "Branded scan page (your slug)",
      "Brand setup (logo & colours)",
      "AI skin type + trait profiling",
      "Product & service matching (2 items)",
      "API access (5 req/min)",
    ],
    disabledFeatures: ["Customer DB & CSV export", "Remove 'Powered by SKINIC'"],
  ...
  },
  {
    ...
    limits: [
      ...
      { label: "Lead capture", value: "Full access", tooltip: "View every lead from your scan page, filter by skin type, and export to CSV." },
    ],
    features: [
      "Everything in Free",
      "Customer DB & CSV export",
      "Unlimited catalog items",
      "Website embed code",
      "AI ingredient guide (API)",
      "Email support",
    ],
