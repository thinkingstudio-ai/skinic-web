    ...
    <section id="pricing" className="py-28 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-white/25 text-sm mt-8">
          ...
          <a href="mailto:skinic@thinkingstudio.ai?subject=Enterprise%20Inquiry%20%E2%80%94%20skinic.app" className="text-violet-400 hover:text-violet-300">Contact us for Enterprise</a>.
        </p>
      </div>
    </section>
  );
