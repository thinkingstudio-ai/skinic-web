...
const STUDIO_TIERS: Tier[] = [
  {
    ...
    limits: [
      ...
      { label: "Lead capture", value: "—", tooltip: "Email lead capture and the Customer database are available on Starter and above." },
    ],
    features: [
    ...
    disabledFeatures: ["Lead capture & Customer DB", "Remove 'Powered by SKINIC'"],
