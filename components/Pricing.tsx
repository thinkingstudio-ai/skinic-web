...
const STUDIO_TIERS: Tier[] = [
  {
    ...
    limits: [
      ...
      { label: "Catalog", value: "—", tooltip: "Product & service catalog is available on Starter and above." },
    ...
    disabledFeatures: ["Product & service matching", "Lead capture & Customer DB", "Remove 'Powered by SKINIC'"],
